...
void Background::advance(Background* background){
    ...
    //BG1
    if(background->Main[0]->getX() <= -3 && background->Repeat[0]->getX() <= -1.01){
    ...
    //BG2
    if(background->Main[1]->getX() <= -3 && background->Repeat[1]->getX() <= -1.01){
    ...
    //BG3
    if(background->Main[2]->getX() <= -3 && background->Repeat[2]->getX() <= -1.01){
    ...
    //BG4
    if(background->Main[3]->getX() <= -3 && background->Repeat[3]->getX() <= -1.01){
    ...
    //BG5
    if(background->Main[4]->getX() <= -3 && background->Repeat[4]->getX() <= -1.01){
